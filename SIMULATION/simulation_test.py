...
def getSpeed(runner):
    ...
    return 0.88*speed+runner['deviation']
...
def main():
	...
	realDataDict = getRealData()

	for minute in range(30,500,10):
		
		realData = realDataDict[minute]
